<template>
  <span
    v-if="rank"
    class="inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-xs font-bold uppercase tracking-wide border shadow-sm"
...
import { getRankColor, getRankIconUrl } from '../../lib/formatters'
