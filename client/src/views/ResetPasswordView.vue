  ...
  <div class="min-h-[70vh] flex items-center justify-center">
    <div class="w-full max-w-md">
      ...
      <BaseCard :hoverable="false" class="!p-6">
        <h2 class="text-xl font-bold text-text-primary text-center mb-4">Créer un nouveau mot de passe</h2>
...
onMounted(async () => {
    ...
    if (!session) {
       message.value = "Session invalide ou expirée. Veuillez redemander un lien de réinitialisation."
    }
})
